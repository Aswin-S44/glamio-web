                  ...
                  : [
                      {
                        author_name: "Ananya",
                        rating: 5,
                        text: "Amazing service and super hygienic!",
                      },
                      {
                        author_name: "Rahul",
                        rating: 4,
                        text: "Stylists are very professional.",
                      },
                      {
                        author_name: "Meera",
                        rating: 5,
                        text: "Loved the ambience and quality.",
                      },
                    ]
                ).map((r, i) => (
                  <div key={i} className="review-card premium">
                    <div className="review-avatar">{r.author_name[0]}</div>
